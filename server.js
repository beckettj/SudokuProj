...
app.get('/api/image/:prompt', async (req, res) => {
  ...
  const imageUrl = `https://image.pollinations.ai/prompt${encodeURIComponent(prompt)}?width=200&height=200&nologo=true&seed=${seed}&model=flux`;
  ...
  headers: { 'User-Agent': 'ThemeSudoku/1.0' },
